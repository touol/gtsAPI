...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $properties = array(
                'name' => 'SkladNaryd',
                'description' => 'Default source for files of SkladNaryd',
                ...
                'properties' => array(
                    'basePath' => array(
                        ...
                        'type' => 'textfield',
                        'lexicon' => 'core:source',
                        'value' => 'assets/images/skladnaryd/',
                    ),
            ...
            if ($setting = $modx->getObject('modSystemSetting', array('key' => 'skladnaryd_source_default'))) {

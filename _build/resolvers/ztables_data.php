<?php
/**
 * Справочные данные пакета (data.json).
 *
 * Имя начинается с z намеренно: резолверы выполняются в алфавитном порядке,
 * а писать строки можно только после того, как tables.php создаст сами таблицы.
 * Пока файл назывался data.php, он шёл ПЕРВЫМ, и на чистой установке установка
 * падала с «Table 'modx_gtsapi_selects' doesn't exist» — списки выбора
 * в админке оставались пустыми.
 */
